...
void LoadTimeTable()
{
	...
	courseList->ReadFile("Course.txt");
	LinkedList<Subject> *subjectList = new LinkedList<Subject>();
	subjectList->ReadFile("Subject.txt");
	LinkedList<Lecturer> lecturerList = new LinkedList<Lecturer>();
	lecturerList->ReadFile("Lecturer.txt");
}
